/*
  ...
  /Users/adigenova/miniconda2/bin/gengetopt --input=intervalmis.ggo --include-getopt -F imopts --no-handle-error 
...
const char *gengetopt_args_info_purpose = "IntervalMiss detect miss-assembled contigs and correct them when necessary.\n\nBy Alex Di Genova <digenova@gmail.com>";

const char *gengetopt_args_info_usage = "Usage: IntervalMiss [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "\nRequired IntervalMiss options:\n",
  "  -c, --contigs=STRING    Fasta file",
  "  -s, --samlist=STRING    List of SAM files",
  "  -p, --prefix=STRING     Prefix for output files",
  "\nAdditional IntervalMiss options:\n",
  "  -d, --mbc=INT           Minimum base coverage, Maximum 10 values [<20]\n                            (default=`5')",
  "  -b, --ccoverage=STRING  File coverage for each contig",
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->mbc_arg = NULL;
  args_info->mbc_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->contigs_help = gengetopt_args_info_help[3] ;
  args_info->samlist_help = gengetopt_args_info_help[4] ;
  args_info->prefix_help = gengetopt_args_info_help[5] ;
  args_info->mbc_help = gengetopt_args_info_help[7] ;
  args_info->mbc_min = 1;
  args_info->mbc_max = 10;
  args_info->ccoverage_help = gengetopt_args_info_help[8] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_multiple_field (args_info->mbc_given, (void *)(args_info->mbc_arg), &(args_info->mbc_orig));
  args_info->mbc_arg = 0;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  write_multiple_into_file(outfile, args_info->mbc_given, "mbc", args_info->mbc_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->mbc_given, args_info->mbc_min, args_info->mbc_max, "'--mbc' ('-d')"))
     error_occurred = 1;
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * mbc_list = NULL;
  int error_occurred = 0;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVc:s:p:d:b:t:l:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'p':	/* Prefix for output files.  */
          ...
          break;
        case 'd':	/* Minimum base coverage, Maximum 10 values [<20].  */
        
          if (update_multiple_arg_temp(&mbc_list, 
              &(local_args_info.mbc_given), optarg, 0, "5", ARG_INT,
              "mbc", 'd',
              additional_error))
            goto failure;
        
          break;
        case 'b':	/* File coverage for each contig.  */
        ...
        case 0:	/* Long option with no short option */
          /* Factor to compute std using avg*fst.  */
          if (strcmp (long_options[option_index].name, "fst") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->fst_arg), 
                 &(args_info->fst_orig), &(args_info->fst_given),
  ...
  update_multiple_arg((void *)&(args_info->mbc_arg),
    &(args_info->mbc_orig), args_info->mbc_given,
    local_args_info.mbc_given, &multiple_default_value,
    ARG_INT, mbc_list);

  args_info->mbc_given += local_args_info.mbc_given;
  local_args_info.mbc_given = 0;
